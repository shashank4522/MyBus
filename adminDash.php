...
<?php
    ...
    <th>Delete</th>
       ...
       while ($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
       {
        ...
        <button style="border:2px black; border-radius:7px; background-color:blue;color:white;">
        ...
        <button style = "border:2px black; border-radius:7px; background-color:red;color:white;" >
